...
namespace xing.cs.form
{
	public partial class FormSetting : Form
	{
		public FormSetting()
		{
			...
			#region 1833 종목검색 설정 가져오기

			// t1833 폴더 경로 세팅
			setting.t1833_dir = setting.program_execute_dir + @"\t1833_dir\";

			Text1833Dir.Text = setting.t1833_dir;

			// 1833 종목검색 리스트 설정
			setting.t1833_files = Properties.Settings.Default.T1833_FILES;
